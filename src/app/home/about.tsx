    ...
    <div className=" py-[60px] " id="about">
      <div className="relative  ">
        <div className="section-bg  py-[120px]  ">
          <div className="max-w-[1440px] px-4 md:px-10 mx-auto flex flex-col lg:flex-row gap-20 lg:py-14">
      ...
      <div className="w-full flex flex-col gap-14 text-[#444444] md:py-8 px-4 md:px-10 md:flex-row  md:flex-wrap lg:flex-nowrap md:justify-center max-w-[1440px] mx-auto  lg:w-[60%]">
