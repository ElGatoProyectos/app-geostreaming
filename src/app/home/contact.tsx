  ...
  return (
    <div className="px-4 py-8">
      ...
      <p className="text-center mb-8">
        Tienes dudas o ya quieres empezar a trabajar con nosotros. Escríbenos o
        llámanos y te daremos la información necesaria.
      </p>
      <div className="grid grid-cols-1 gap-8">
        <div className="grid grid-cols-1 gap-8">
          <div className="text-center text-[#444444] shadow-box flex flex-col justify-center items-center p-8 bg-white">
            <div className="w-12 h-12 flex items-center justify-center p-2 rounded-full  border-[#F06FAC] border-2 border-dotted bg-white shadow-box mb-16">
              <FaMapMarkerAlt className="text-2xl text-[#F2308B]" />
            </div>
            <h3 className="font-bold text-xl mb-4 text-[#777777]">Ubícanos</h3>
            <p className="text-sm">Argentinos y Pichincha, RIOBAMBA, ECUADOR</p>
          </div>
          <div className="text-center text-[#444444] shadow-box flex flex-col justify-center items-center p-8">
          ...
          <div className="text-center text-[#444444] shadow-box flex flex-col justify-center items-center p-8">
            ...
            <h3 className="font-bold text-xl mb-4 text-[#777777]">Llámanos</h3>
